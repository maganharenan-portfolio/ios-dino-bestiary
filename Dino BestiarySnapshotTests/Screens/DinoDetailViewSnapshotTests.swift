...
struct DinoDetailViewSnapshotTests {
    ...
    @Test func test_detail_view_common_text() async throws {
    ...
    @Test func test_detail_view_verbose_text() async throws {
    ...
    @Test func test_detail_view_whole_screen_common_text() async throws {
        let view = DinoDetailView(dino: Dino.mock)
            .environment(\.isSnapshotTesting, true)
    ...
    @Test func test_detail_view_whole_screen_verbose_text() async throws {
        let view = DinoDetailView(dino: Dino.mockVerbose)
            .environment(\.isSnapshotTesting, true)
