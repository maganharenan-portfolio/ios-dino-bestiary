//
//  DinoGridViewSnapshotTests.swift
//  Dino Bestiary
//
...
struct DinoGridViewSnapshotTests {
    
    @Test func common_strings() async throws {
        let view = NamespaceWrapper { namespace in
            DinoGridView(dinos: Dino.mockArray, dinoFileLayout: namespace)
        }
    ...
    @Test func verbose_strings() async throws {
        let view = NamespaceWrapper { namespace in
            DinoGridView(dinos: Dino.mockArrayVerbose, dinoFileLayout: namespace)
        }
